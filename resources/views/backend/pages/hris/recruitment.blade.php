...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Attrition Rate Annually</h5>
            </div>
            <div class="col-12">
                <div class="card-body" style="padding: 0px !important;">
                    <div style="padding: 1em;"></div>
                    <h5 class="text-primary">25 <span class="text-percentage"></span></h5>
                    <h6 class="card-subtitle text-muted">No of Employees Left Workplace</h6>
                    <hr>
                    <h5 class="text-primary">650 <span class="text-percentage"></span></h5>
                    <h6 class="card-subtitle text-muted">Average No of Employees</h6>
                    <hr>
                    <h5 class="text-primary">0.038%</h5>
                    <h6 class="card-subtitle text-muted">Attrition Rate</h6>
                    <hr>
                    <div style="padding: 1em;"></div>
                </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            new Chart(document.getElementById("chartjs-pie"), {
                type: "pie",
                data: {
                    labels: ["Internal Medicine", "Anesthesiology", "Dental Medicine", "Emergency Medicine", "Family and Community Medicine", "Surgery", "Pediatrics", "Opthalmology"],
                    datasets: [{
                        data: [98, 12, 38, 42, 28, 24, 68, 72],
                        backgroundColor: [
