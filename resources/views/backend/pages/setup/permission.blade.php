    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Permission Screen
    ...
    <script>
        ...
        $(function() {
            ...
            $('#save_record').validate({
                submitHandler: function (form) {
                    ...
                    if(record_id === null) {
                        scion.record.add('/settings/permission/save', formData,
                        function() {
                        ...
                        scion.record.update('/settings/permission/update', record_id, formData,
                        function() {
                            $('#datatables').DataTable().draw();
                            $('#classModal').modal('hide');
                        },
        ...
        function edit(id){
            ...
            $.ajax({
                ...
                url: '/settings/permission/edit/' + id,
                method: 'get',
                data: {},
                success: function(data) {
                    $('.modal-title').text('Update Permission');
        ...
        function deleteRecord(id) {
            delete_func = scion.record.delete('/settings/permission/destroy', id,
            function() {
                $('#datatables').DataTable().draw();
            },
            function() {
